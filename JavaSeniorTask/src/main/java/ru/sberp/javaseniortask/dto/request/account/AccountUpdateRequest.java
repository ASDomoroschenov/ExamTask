...
public class AccountUpdateRequest {
  ...
  @Min(value = 1L, message = "Идентификатор аккаунта не может быть меньше 1")
  @Max(value = 999999999999L, message = "Идентификатор аккаунта не может быть больше 999999999999")
